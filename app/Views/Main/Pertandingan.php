                        ...
                        <div class="overflow-x-auto">
                            <table class="table -mt-2 table-auto border-collapse ">
                                <tbody>
                                    <tr>
                                        <td>
                                            <select name="klubasatu" id="klubasatu" required class="form-select w-52 h-10" aria-label="select example">
                                        ...
                                        <td>
                                            <select name="klubbsatu" required id="klubbsatu" class="form-select w-52 h-10" aria-label="select example">
                        ...
                        <div class="overflow-x-auto">
                            <table class="table -mt-2 table-auto border-collapse ">
                                <tbody id="tabel_tambah">
                                    <tr>
                                        <td>
                                            <select name="kluba[]" required class="form-select w-50 h-10" aria-label="select example">
                                                <option selected="" disabled="" value="">-- Pilih Klub 1 --</option>
                                                <?php
                                                foreach ($klub as $klubdata) : ?>
                                                    <option value=<?= $klubdata['id']; ?>><?= $klubdata['Nama_klub']; ?></option>
                                        ...
                                        <td>
                                            <select name="klubb[]" required class="form-select w-50 h-10" aria-label="select example">
                                                <option selected="" disabled="" value="">-- Pilih Klub 2 --</option>
            ...
            $('#btn_tambahform').click(function(e) {
                ...
                $('#tabel_tambah').append(
                    `<tr>
                                        ...
                                        <td>
                                            <input name="skora[]" id="modal-form-3" type="number" class="form-control-noborder w-24 h-6" required placeholder="Skor Klub ` + ((++jumlahskora * 2) - 1) + `">
                                        </td>
                                        ...
                                        <td>
                                            <input name="skorb[]" required id="modal-form-3" type="number" class="form-control-noborder w-24 h-6" placeholder="Skor Klub ` + ((++jumlahskorb * 2) - 2) + `">
                                        </td>
